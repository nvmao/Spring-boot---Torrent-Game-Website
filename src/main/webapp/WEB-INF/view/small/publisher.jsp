        ...
        <div class="ui centered grid">
            <c:forEach var="pub" items="${publishers}">
                <div class="five wide column">
                    ...
                    <a class="ui red tiny label" href="${pageContext.request.contextPath}/publishers/${pub.id}/delete">X</a>
                </div>
            </c:forEach>
        </div>

        <div class="ui centered grid" style="margin-top: 100px">
            <form:form class="ui form" method="POST" action="${pageContext.request.contextPath}/publishers/add">
